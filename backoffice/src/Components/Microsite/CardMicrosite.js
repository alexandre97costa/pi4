...
export default function CardMicrosite(props) {
  return (
    <Link to={props.path} className="card text-decoration-none text-dark text-center shadow bg-body rounded h-100 cursor-pointer" onClick={() => console.log(props.titulo)}>
