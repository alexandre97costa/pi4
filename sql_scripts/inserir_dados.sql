...
insert into ponto_interesse(id, nome, morada, codigo_postal, num_telemovel, num_pontos, descricao, created_at, updated_at, deleted_at, freguesia_id, agente_turistico_id, tipo_interesse_id) values
(1, 'Jardim das Mães',      'Uma morada já com alguns carateres, prai cinquenta', '1566-895', 123456789, 10, 'Uma descrição', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null , 1, 1, 1),
(2, 'Jardim dos Pais',      'Uma morada já com alguns carateres, prai cinquenta', '1566-895', 123456789, 10, 'Uma descrição', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null , 2, 1, 2),
(3, 'Jardim das Primas',    'Uma morada já com alguns carateres, prai cinquenta', '1566-895', 123456789, 10, 'Uma descrição', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null , 3, 1, 3),
(4, 'Jardim dos Tios',      'Uma morada já com alguns carateres, prai cinquenta', '1566-895', 123456789, 10, 'Uma descrição', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null , 4, 1, 4),
(5, 'Jardim dos Avós',      'Uma morada já com alguns carateres, prai cinquenta', '1566-895', 123456789, 10, 'Uma descrição', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null , 5, 1, 5),
(6, 'Jardim das Cunhadas',  'Uma morada já com alguns carateres, prai cinquenta', '1566-895', 123456789, 10, 'Uma descrição', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null , 6, 1, 6);