      ...
      <CardBackground className="border-0 text-center shadow rounded-4 m-5 p-4">
        ...
        <div className="collapse" id="collapseExample6">
          <div className="pt-3">
            ...
            <p className="w-75 mx-auto">
              Usamos cookies por várias razões detalhadas abaixo. Infelizmente,
              na maioria dos casos, não há opções padrão da indústria para
              desativar cookies sem desativar completamente a funcionalidade e
              os recursos que eles adicionam a este site.
            </p>
            <div className="collapse" id="collapseExample4">
              <p className="w-75 mx-auto">
                É recomendável que você deixe todos os cookies ativados se não
                tiver certeza se precisa deles ou não, caso eles sejam usados
